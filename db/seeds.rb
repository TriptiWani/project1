...
Order.destroy_all
User.destroy_all
User.create(:first_name=>"Admin",:last_name=>"",:email=>"tripti.895@gmail.com",:dob=>"1986-11-15", :gender => "F" , :password => "chicken" ,:password_confirmation=>"chicken", :phone_number =>"481254765" , :address => "Canberra" ,:image => "cute_girl.jpg",:admin => true)
...
User.create(:first_name=>"Pam",:last_name=>"Anderson",:email=>"pamand@ga.com","dob"=>"1995-2-6", :gender => "F" , :password => "chicken" ,:password_confirmation=>"chicken", :phone_number =>"967345876" , :address => "" ,:image => "")
